...
#viki experiment pesawat alien tengah
acollision_x1 = 240
acollision_y1 = 560
acollision_x2 = 312
...
def timer(value):
    ...
    global nyawa_user
    #global ari viki
    global ucollision_x1, ucollision_x2, ucollision_y1
    global acollision_x1, acollision_x2, acollision_y1
    ...
    if boolGerakY == False:
        deltaYy += gerakY
        deltaX += gerakX
        ucollision_x1 += gerakX
        ucollision_y1 += gerakY
    ...
    #try colision antara peluru user dan pesawat alien

    if 240 <= ucollision_x1 <= 300:
        if ucollision_y1 == 560:
            print("pesawat alien tengah hancur !!!!")
    ...
    #jika peluru mencapai 450 maka kembali keposisi awal
    if deltaYy == 450:
        deltaYy = 0
        ucollision_x1 = 0
        ucollision_y1 = 0
    ...
    #jika peluru alien mencapai -700 maka kembali keposisi awal
    if deltaYy1 == -700:
        deltaYy1 = 0

    if acollisionY1 == pos_x:
        nyawa_user -= 1
        if nyawa_user == 0:
            print('Game Over')
